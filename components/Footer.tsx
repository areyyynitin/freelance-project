...
export default function Footer() {
  ...
  return (
    <>
      <footer
        ref={footerRef}
        className="bg-primary w-full font-serif text-text h-[100svh] pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl  flex flex-col"
      >
        <div
          ref={containerRef}
          className="max-w-7xl mx-auto mt-10 grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12"
        >
          <div className="lg:col-span-3 space-y-6">
            ...
            <p className="text-sm/6 text-text/60 max-w-96">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <ul className="space-y-3 text-sm text-text/60">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] px-2 py-0.5 rounded-full bg-accent/20 border border-accent text-text">
                    HIRING
                  </span>
                </li>
                <li>
